...
public class Wallet : MonoBehaviour
{
    ...
    {
        transform.GetChild(previouslySelected).GetComponent<SpriteRenderer>().color = Color.white;
        transform.GetChild(indexSelected).GetComponent<SpriteRenderer>().color = Color.green;
    }
